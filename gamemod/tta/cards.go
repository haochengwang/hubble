...
const (
	...
	// Events
	TRAIT_DEVELOPMENT_OF_AGRICULTURE
	TRAIT_DEVELOPMENT_OF_CIVILIZATION
	TRAIT_DEVELOPMENT_OF_CRAFTS
	TRAIT_DEVELOPMENT_OF_MARKETS
	TRAIT_DEVELOPMENT_OF_POLITICS
	TRAIT_DEVELOPMENT_OF_RELIGION
	TRAIT_DEVELOPMENT_OF_SCIENCE
	TRAIT_DEVELOPMENT_OF_SETTLEMENT
	TRAIT_DEVELOPMENT_OF_TRADE_ROUTE
	TRAIT_DEVELOPMENT_OF_WARFARE
)
